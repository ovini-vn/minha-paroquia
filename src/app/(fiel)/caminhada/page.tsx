  ...
  return (
    <div className="flex flex-col">
      ...
      {/*
        ...
        À esquerda o registro — sacramentos, missas, confissão —, que é o
        que a pessoa veio fazer. À direita "quem vê o quê", que é consulta:
        ela registra confissão numa tela da paróquia e precisa saber, de
        relance, o que fica só com ela. Empilhada no fim de uma coluna
        única, essa explicação vive abaixo da dobra justamente para quem
        hesita em registrar.
      */}
      <DuasColunas
        principal={
