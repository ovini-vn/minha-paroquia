...
export default async function TurmaPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/*
        No computador, a frequência vira LADO A LADO.

        Vertical já estava certo — chamada primeiro, configuração por
        último. Numa tela larga dá para ter as duas ao mesmo tempo: o
        trabalho da semana à esquerda, e matricular e os dados da turma à
        direita, onde ficam à mão sem empurrar nada.

        No celular volta a ser uma pilha, na mesma ordem de hoje: o
