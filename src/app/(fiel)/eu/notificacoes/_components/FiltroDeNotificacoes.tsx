...
export function FiltroDeNotificacoes({
  ...
  const base =
    "alvo-de-toque inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1.5 text-[13px] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary";
